...
const TreeSelect = () => {
  ...
  const { setCurrentTree, initializeTree, saveSlots, activeSlot } = useGameStore();

  // For now, all trees are unlocked. Later we can track progress
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 text-center">
          ...
          <p className="font-body text-muted-foreground">
            Each tree presents greater challenges and rewards
          </p>
        </div>
            ...
            return (
              <Card
                ...
                className={`group fantasy-border transition-all duration-300 ${
                  isLocked 
                    ...
                    : "cursor-pointer hover:card-glow hover:scale-[1.02]"
                }`}
              ...
              >
                ...
                <CardContent className="text-center">
                  <p className={`text-sm font-body ${tree.id === 0 ? "text-muted-foreground" : "text-orange-400"}`}>
                    {tree.modifier}
                  </p>
                  {!isLocked && (
                    <Button className="mt-4 w-full font-title">
                      Enter
                    </Button>
                  )}
                </CardContent>
