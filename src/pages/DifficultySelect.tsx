      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 text-center">
          ...
          <p className="font-body text-muted-foreground">
            Choose your challenge level - affects all enemy stats
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardHeader className="text-center">
                  <div className={`mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-muted transition-colors group-hover:bg-muted/80`}>
                    <Icon className={`h-8 w-8 ${colorClass}`} />
                  </div>
                  <CardTitle className={`font-title text-xl ${colorClass}`}>
                    {diff.label}
                  </CardTitle>
                ...
                <CardContent className="text-center">
                  <p className="text-sm text-muted-foreground font-body">
                    Enemy stats multiplier: <span className={`font-bold ${colorClass}`}>{diff.multiplier * 100}%</span>
                  </p>
